...
Built on [regfans](https://github.com/natemacfadden/regfans) for triangulation computation.
...
Much of this project was developed with the assistance of [Claude Code](https://claude.ai/claude-code) (Anthropic).
